...
Los quince archivos están verificados: los catorce cuadernos ejecutables se corren de punta
a punta con `nbclient` y terminan sin errores. El único que no corre completo es `03b`, que
es incompleto **a propósito** (ver la tabla).
...
| `11_Viscosidad_por_caida_de_esferas.ipynb` | 11 | ¿Puedo medir la viscosidad dejando caer una esfera? Stokes, Reynolds, corrección de Ladenburg, ajuste ponderado por el origen | [Colab](https://colab.research.google.com/github/charlyacha/Labo1-colabs/blob/main/11_Viscosidad_por_caida_de_esferas.ipynb) |
